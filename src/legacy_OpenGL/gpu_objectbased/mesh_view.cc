...
void redraw()
{
	...
	// update FPS counter
	fps->updateCounter();
	std::stringstream out;out << "NPR Thesis Jeroen Baert | Polys: " << meshes[0]->faces.size() << " | FPS: " << fps->FPS;string s = out.str();
...
int main(int argc, char *argv[])
{
	...
	if(iUnits < 5){printf("Not enough texture units available...\n");exit(3);}
	else{printf(" ... OK\n");}
